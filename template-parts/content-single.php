<article id="post-<?php the_ID(); ?>" <?php post_class('flex flex-col'); ?>>
    ...
    <section class="container mx-auto px-6 pb-24 pt-16 lg:px-8">
        <div class="entry-content mx-auto max-w-3xl space-y-8 text-base leading-7 text-zinc-600 sm:text-lg [&_a]:text-primary [&_a]:underline [&_a:hover]:text-primary/80 [&_blockquote]:border-l-4 [&_blockquote]:border-primary [&_blockquote]:pl-4 [&_blockquote]:text-zinc-950 [&_h2]:mt-12 [&_h2]:text-3xl [&_h2]:font-semibold [&_h2]:text-zinc-950 [&_h3]:mt-10 [&_h3]:text-2xl [&_h3]:font-semibold [&_h3]:text-zinc-950 [&_.wp-block-button__link]:inline-flex [&_.wp-block-button__link]:items-center [&_.wp-block-button__link]:justify-center [&_.wp-block-button__link]:rounded-full [&_.wp-block-button__link]:bg-dark [&_.wp-block-button__link]:px-4 [&_.wp-block-button__link]:py-1.5 [&_.wp-block-button__link]:text-sm [&_.wp-block-button__link]:font-semibold [&_.wp-block-button__link]:text-white [&_.wp-block-button__link:hover]:bg-dark/90 [&_.wp-block-quote]:border-l-4 [&_.wp-block-quote]:border-primary [&_.wp-block-quote]:pl-4">
            <?php the_content(); ?>
